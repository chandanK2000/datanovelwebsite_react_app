        ...
        <div className="mega-block">
          ...
          <ul className="mega-list list-unstyled">
            ...
            <li className="dropdown-submenu position-relative">
              <Link className="dropdown-item dropdown-toggle  no-click" to="#" data-bs-toggle="dropdown">
                Enterprise
              </Link>
              <ul className="dropdown-menu">
                <li><Link className="dropdown-item" to="/digital-transformation" onClick={closeMenus}>Digital Transformation</Link></li>
                <li><Link className="dropdown-item" to="/application-development" onClick={closeMenus}>Application Development<br/> and Management</Link></li>
